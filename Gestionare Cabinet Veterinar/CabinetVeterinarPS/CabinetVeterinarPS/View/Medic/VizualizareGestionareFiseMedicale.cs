...
{
    public partial class VizualizareGestionareFiseMedicale : Form, IVizualizareGestionareFiseMedicale
    {
        public string Simptome
        {
            get
            {
                if (this.txtSimptome.Text == "")
                    return "";
                else
                    return this.txtSimptome.Text;
            }
            set
            {
                this.txtSimptome.Text = value;
            }
        }
        ...
        public VizualizareGestionareFiseMedicale()
        {
            InitializeComponent();
        ...
        private void VizualizareGestionareFiseMedicale_Load(object sender, EventArgs e)
        {

        }

        private void btnVizFise_Click(object sender, EventArgs e)
        {
            PrezentareGestionareFiseMedicaleMedic pp = new PrezentareGestionareFiseMedicaleMedic(this);
            pp.Lista();
        }
